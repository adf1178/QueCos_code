...
def cook_test(test, reflens_refmaxcounts, n=4):
    '''Takes a test sentence and returns an object that
    encapsulates everything that BLEU needs to know about it.'''

    reflens, refmaxcounts = reflens_refmaxcounts
    test = normalize(test)
    result = {}
...
def computeMapsFromPairList(predictions, golds):
    """

    :param predictions: a list of (rid, pred) pairs. "pred" is a sentence without <SOS> or <EOS>.
    :param golds: a list of (rid, gold) pairs. Multiple references = Multiple golds for one rid.
        "gold" is a sentence without <SOS> or <EOS>.
    :return:
    """
    predictionMap = {}
    goldMap = {}
